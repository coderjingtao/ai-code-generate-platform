package dev.jingtao.aicodebackend.langgraph4j.model;
...
public class ImageCollectionPlan implements Serializable {
    ...
    /**
     * Logo搜索任务
     * 对应 LogoSearchTool.searchLogos(String query)
     */
    public record LogoTask(String query) implements Serializable {}
}
